...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "User is not contract owner");
        _;
    }

    //  4) fill out the transferOwnership function
    function transferOwnership(address newAddress) public onlyOwner {
        require(!newAddress.isContract(), "contract address is not allowed for ownership, please use external account.");
        _owner = newAddress;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(ownerOf(tokenId) != to, "The new address is the current owner of the token.");
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!to.isContract(), "Given address is a invalid because it is a contract");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "The given address is not the owner of the token");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "The token not exist.");
...
contract MSDRealEstateERC721Token is ERC721Metadata("MSDRealEstate", "MSD", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
    constructor() public{
