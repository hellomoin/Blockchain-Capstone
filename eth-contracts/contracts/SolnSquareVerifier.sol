...
contract SolnSquareVerifier is MSDRealEstateToken, SquareVerifier {
    ...
    function mint(address to, uint256 tokenId) public returns(bool) {
        require(uniqueSolutionsByTokenId[tokenId].verified == true, "A solution must contain a token");
